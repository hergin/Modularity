...
public class Main {
    public static void main(String[] args) {
        ...
        var theNumbers = theProvider.provideNumbers(); //changed

        System.out.println("BEFORE SORTING: [" + theNumbers.stream().map(Object::toString).collect(Collectors.joining(",")) + "]");

        NumberSorter theSorter = new SelectionSorter(); //changed
        ...
        NumberExporter theExporter = new ConsoleExporter(); //changed
